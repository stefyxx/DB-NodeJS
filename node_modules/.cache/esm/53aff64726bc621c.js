...
//export const aQuery = "SELECT * FROM \"gtfsStopTimes\" LIMIT 10";
       ...
       const aQuery = "SELECT * FROM \"gtfsTrips\" JOIN \"gtfsStopTimes\" ON \"gtfsTrips\".\"id\" = \"gtfsStopTimes\".\"stopId\" WHERE \"gtfsStopTimes\".\"agencyId\" = 'stibmivb' LIMIT 10";