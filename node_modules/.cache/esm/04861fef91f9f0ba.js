let configuration,aQuery;_91f‍.w("./config.js",[["configuration",["configuration"],function(v){configuration=v}]]);_91f‍.w("./aQuery",[["aQuery",["aQuery"],function(v){aQuery=v}]]);
...
function ProcessData(query) {
    ...
    .then(function success(result) {
        // key rows : [{},{},..]
        _91f‍.g.console.log(result.rows)
    ...
    .catch(function error(err) {
        _91f‍.g.console.error('failure', err)
    })
}
